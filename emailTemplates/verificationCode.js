    ...
    return (
       ...
       ${data.mainHeading && (` <h1 style="font-family: Roboto,RobotoDraft,Helvetica,Arial,sans-serif;
        ...
        <div style="width:100%;
            ...
            color: #f3f3f3; 
            font-family: Roboto,RobotoDraft,Helvetica,Arial,sans-serif;
            font-size: 35px;">Mooli</h1>
            <div style=" display:flex; flex-direction:row;">
          
            <div style="width:30%;">
                <p>Address:   <span style="margin-left:3%; font-weight:bold;">Karachi- Pakistan</span> </p>
            ...
            <div style ="margin-left:10%; width:50%;">
                <p>email:  <span style="margin-left:3%; font-weight:bold; color:#f3f3f3;">info@mooli.com </span> </p>      
                <p>P.O.Box:  <span style="margin-left:3%; font-weight:bold;">abc 121 street </span> </p>
            </div>
            </div>
        </div>
    </div>
